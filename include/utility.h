...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<int>("lio_sam/N_SCAN", N_SCAN, 32);
        ...
        nh.param<float>("lio_sam/imuGyrNoise", imuGyrNoise, 0.003);
        nh.param<float>("lio_sam/imuAccBiasN", imuAccBiasN, 0.0001);
        nh.param<float>("lio_sam/imuGyrBiasN", imuGyrBiasN, 0.00004);
        nh.param<float>("lio_sam/imuGravity", imuGravity, 9.79333);
